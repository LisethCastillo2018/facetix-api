"""
Django settings for facetix_api project.
...
APPS_DIR = ROOT_DIR.path('facetix_api')
...
LOCAL_APPS = [
    'facetix_api.users.apps.UsersConfig',
    'facetix_api.utils.apps.UtilsConfig',
    'facetix_api.events.apps.EventsConfig',
]
